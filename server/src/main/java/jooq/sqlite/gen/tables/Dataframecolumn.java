...
public class Dataframecolumn extends TableImpl<DataframecolumnRecord> {
    ...
    private static final long serialVersionUID = 955972697;

    /**
     * The reference instance of <code>DataFrameColumn</code>
     */
    ...
    /**
     * The column <code>DataFrameColumn.id</code>.
     */
    public final TableField<DataframecolumnRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>DataFrameColumn.dfId</code>.
     */
    ...
    /**
     * The column <code>DataFrameColumn.name</code>.
     */
    ...
    /**
     * The column <code>DataFrameColumn.type</code>.
     */
    ...
    /**
     * Create a <code>DataFrameColumn</code> table reference
     */
    ...
    /**
     * Create an aliased <code>DataFrameColumn</code> table reference
     */
    ...
    public UniqueKey<DataframecolumnRecord> getPrimaryKey() {
        return Keys.PK_DATAFRAMECOLUMN;
    }
    ...
    public List<UniqueKey<DataframecolumnRecord>> getKeys() {
        return Arrays.<UniqueKey<DataframecolumnRecord>>asList(Keys.PK_DATAFRAMECOLUMN);
    }
    ...
    public List<ForeignKey<DataframecolumnRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<DataframecolumnRecord, ?>>asList(Keys.FK_DATAFRAMECOLUMN_DATAFRAME_1);
    }
